...
ventana.config(bg="#939d9d")
ventana.iconbitmap(resource_path("assets/icon.ico"))

centrar_ventana_en_pantalla(ventana, 500, 205)

# Etiqueta y campo de entrada
tk.Label(ventana, text="Pega la ruta: ", bg="#939d9d", fg="white", font=("Arial", 10, "bold")).pack(pady=5)
...
# Campo de salida
tk.Label(ventana, text="Ruta convertida: ", bg="#939d9d", fg="white", font=("Arial", 10, "bold")).pack(pady=5)
